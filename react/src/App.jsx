...
function App() {
  ...
  console.log("Funcionou!"); //Toda vez que o estado for atualizado, essa linha será executada também.
  ...
  return (
    ...
    <> {/*Fragment. Um elemento pai que desaparece na renderização.*/}
      ...
      <br />
      <input type="text" onChange={(event) => setInput(inputName = event.target.value)}/>
      <h2>Olá, {inputName}</h2>
    </>
  ) 
}
